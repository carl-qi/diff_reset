...
KEY_TO_STATUS = {
    ...
    **dict.fromkeys([ord("w"), ord("W")], (2, -1)),  # forward
    **dict.fromkeys([ord("s"), ord("S")], (2, 1)),  # backward
    **dict.fromkeys([ord("q"), ord("Q")], (3, -1)),  # forward
    **dict.fromkeys([ord("e"), ord("E")], (3, 1)),  # backward
    **dict.fromkeys([ord("u"), ord("U")], (4, -1)),  # forward
    **dict.fromkeys([ord("i"), ord("I")], (4, 1)),  # backward
    **dict.fromkeys([ord(","), ord("<")], (5, -1)),  # forward
    **dict.fromkeys([ord("."), ord(">")], (5, 1)),  # backward
    **dict.fromkeys([ord("v"), ord("V")], (6, -1)),  # forward
    **dict.fromkeys([ord("b"), ord("B")], (6, 1)),  # backward
